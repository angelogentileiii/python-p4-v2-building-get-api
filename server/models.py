...
class Game(db.Model, SerializerMixin):
    ...
    users = association_proxy("reviews", "game", creator= lambda user_obj: Review(user=user_obj))
...
class User(db.Model, SerializerMixin):
    ...
    games = association_proxy("reviews", "user", creator=lambda game_obj: Review(game=game_obj))
